...
|---|---|---|---|---|---|
| `S1-search-results-wide` | Query submitted, wide dual-pane layout, selected hit visible | `screenshots/screenshot_01.webp` | `tests/snapshots/cassapp_results_wide.snap` | captured | n/a |
...
| `S6-search-results-narrow` | Query submitted, narrow single-pane layout | `screenshots/screenshot_01.webp` | `tests/snapshots/cassapp_results_narrow.snap` | captured | n/a |
...
| Filter pills (state, affordance, click targets) | Pills clearly indicate active filters and support interaction | at_risk | `src/ui/app.rs:4030`, `src/ui/app.rs:4077`, `src/ui/app.rs:17071`, `src/ui/app.rs:17093` | `coding_agent_session_search-2dccg.8.2`, `coding_agent_session_search-2dccg.8.3`, `coding_agent_session_search-2dccg.6.2` |
| Result list hierarchy (score/source/snippet) | Fast scan of score + provenance + snippet quality | at_risk | `tests/snapshots/cassapp_results_wide.snap`, `src/ui/app.rs:14519`, `src/ui/app.rs:16924` | `coding_agent_session_search-2dccg.9.1`, `coding_agent_session_search-2dccg.9.2`, `coding_agent_session_search-2dccg.9.3`, `coding_agent_session_search-2dccg.9.5` |
...
| Detail find bar + match counters + key flows | `/`, `n`, `N`, `Esc` flows remain reliable with visible match state | at_risk | `src/ui/app.rs:15420`, `src/ui/app.rs:15438`, `src/ui/app.rs:15523`, `src/ui/app.rs:4947` | `coding_agent_session_search-2dccg.4.1`, `coding_agent_session_search-2dccg.4.2`, `coding_agent_session_search-2dccg.4.3` |
...
| `NR-02` | Filter-pill interaction fidelity | Left-click enters edit mode, right-click clears target filter, pills remain visible at medium/wide widths | at_risk | `src/ui/app.rs:17071`, `src/ui/app.rs:17093`, `src/ui/app.rs:4077` | `coding_agent_session_search-2dccg.8.2`, `coding_agent_session_search-2dccg.8.3`, `coding_agent_session_search-2dccg.6.2` |
| `NR-03` | Results hierarchy scanability | Score/source/snippet cues remain legible across wide+narrow and no key metadata silently disappears | at_risk | `tests/snapshots/cassapp_results_wide.snap`, `tests/snapshots/cassapp_results_narrow.snap` | `coding_agent_session_search-2dccg.9.1`, `coding_agent_session_search-2dccg.9.2`, `coding_agent_session_search-2dccg.9.3` |
...
| `NR-05` | Detail-find behavior + visibility | `/` opens find, `Esc` closes find before detail modal, match counters/highlighting are visible and correct | at_risk | `src/ui/app.rs:15420`, `src/ui/app.rs:15523`, `src/ui/app.rs:4698`, `src/ui/app.rs:4947` | `coding_agent_session_search-2dccg.4.1`, `coding_agent_session_search-2dccg.4.2`, `coding_agent_session_search-2dccg.4.3` |
...
- `NR-02`, `NR-03`, and `NR-05` remain open quality targets and must be resolved before final go/no-go signoff.
