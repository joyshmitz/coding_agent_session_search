...
- Current `NR-03` blocker signal (2026-02-11): `snapshot_search_surface_breakpoint_matrix` narrow snapshot drift (`mt suffix` cue width/truncation delta) under active parity work.
